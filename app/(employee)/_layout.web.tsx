      ...
      {topNav ? (
        <>
          <DesktopTopBar
            ...
            rightActions={
              <>
                <TopBarIconButton icon="calendar-outline" label="אירועים" onPress={() => router.push('/(employee)/employee-events')} />
                <TopBarIconButton icon="person-circle" label="פרופיל" onPress={() => router.push('/(employee)/employee-profile')} />
              </>
            }
            leftActions={
              <>
